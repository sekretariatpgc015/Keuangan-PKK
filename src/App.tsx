        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-white p-1 rounded-xl shadow-sm border border-pink-100 flex items-center justify-center overflow-hidden h-10 w-10">
              <img src="https://cdn.phototourl.com/uploads/2026-03-11-d23181de-15ee-45b4-b946-5d372634f5fb.png" alt="Logo PKK" className="h-full w-full object-contain" referrerPolicy="no-referrer" />
            </div>
            <div>
              <h1 className="font-bold text-lg text-pink-900 leading-tight">PKK Cendrawasih 1</h1>
